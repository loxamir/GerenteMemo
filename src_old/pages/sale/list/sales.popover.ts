...
@Component({
  template: `
    <ion-list>
      <button style="background-color: white;" ion-item (click)="receivable()">Cuentas A Cobrar</ion-button>
      ...
      <!--button ion-item (click)="importer()">Importador Ventas</ion-button>
      <button ion-item (click)="importerLine()">Importador Lineas</ion-button-->
    </ion-list>
  `
})
