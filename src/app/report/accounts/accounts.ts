...
@Component({
  selector: 'accounts-report-page',
  templateUrl: 'accounts.html'
})
export class AccountsReportPage {
@ViewChild(Select) select: Select;
  ...
  openAccount(view) {
    let profileModal = this.modal.create(AccountPage, {'_id': view._id});
    profileModal.present();
  }
  ...
  ionViewWillLoad() {
    ...
    this.accountsReportForm = this.formBuilder.group({
      ...
      dateEnd: new FormControl(this.navParams.data.dateEnd||this.today.toISOString()),
...
`
  ...
  addItem(){
    if (this.accountsReportForm.value.state=='QUOTATION'){
      ...
      this.navCtrl.push(ProductsPage, {"select": true});
    }
  }
  ...
  //     })
  //     this.navCtrl.push(PaymentConditionListPage, {"select": true});
  //   }
  // }
