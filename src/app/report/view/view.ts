...
import { NavController, App, LoadingController, NavParams, ViewController, Events, ModalController } from '@ionic/angular';
...
export class ViewPage {
  ...
  gotoDoc(view) {
    ...
    // this.navCtrl.push(AccountPage, {'_id': view.doc._id});
  }
  ...
  gotoView(view) {
    ...
    this.navCtrl.push(ViewPage, {'_id': view._id});
  }
