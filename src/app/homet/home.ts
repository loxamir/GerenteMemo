       ...
       this.ngZone.run(()=> {
         ...
         this.read().then(teste => {
           if (result['result']['actionIncomplete']){
             ...
             this.navCtrl.push(SalePage,{'contact': {'name': result['result']['parameters']['given-name']}});
             ...
             // })
             this.navCtrl.push(PurchasePage,{'items': items});
           } else if (result['result']['metadata']['intentName'] == 'saleReport'){
             this.navCtrl.push(ReportPage,{'compute': true});
           }
