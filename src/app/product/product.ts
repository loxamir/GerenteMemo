...
import { NavController, NavParams, ModalController, LoadingController, Platform, ViewController, Select, TextInput, Events } from '@ionic/angular';
...
@ViewChild('stock') stock: TextInput;
  ...
  selectCategory() {
      ...
      this.navCtrl.push(CategoriesPage, {"select": true});
  }
