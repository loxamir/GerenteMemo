...
import { NavController, App, NavParams, LoadingController, ViewController, Events, PopoverController } from '@ionic/angular';
...
export class WarehousesPage {
  ...
  //     this.navCtrl.push(WarehousePage, {'_id': warehouse._id});
  //   } else {
  ...
  createWarehouse(){
    ...
    this.navCtrl.push(WarehousePage, {'create': true});
  }
