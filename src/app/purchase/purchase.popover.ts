...
@Component({
  ...
  <ion-list>
    ...
    <ion-item (click)="cancel()" *ngIf="navParams.data.doc.purchaseForm.value.state=='CONFIRMED' && navParams.data.doc.purchaseForm.value.date.split('T')[0]==today.split('T')[0]">Desconfirmar</ion-item>
  </ion-list>
  `
})
