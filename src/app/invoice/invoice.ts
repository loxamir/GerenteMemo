...
import { NavController, App, NavParams, LoadingController, AlertController, Select, Events, ToastController, ModalController, PopoverController } from '@ionic/angular';
